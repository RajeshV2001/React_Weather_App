    ...
    return (
        <>
            <div className="h-screen bg-gray-900 flex items-center justify-center p-4">
                <div className="bg-gray-800 rounded-xl shadow-2xl w-[50%] h-[85%] p-6 transform hover:scale-[1.01] transition-all duration-300 hover:border-gray-400">
                    <div className="flex justify-center mt-6">
                        <h1 className="font-bold text-4xl bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text">WEATHER APP</h1>
                    </div>
                    ...
                    <div className="flex justify-center gap-10 mt-6">
                        ...
                        <div>
                            <button
                                className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white rounded-lg p-2 w-[10vh] font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg"
                    ...
                    <div className="px-8 mt-12 flex flex-col gap-2">
                        ...
                        <div className="flex items-center gap-4">
                            <h1 className="flex font-bold text-4xl text-gray-300">{data ? data.location.country : ""}, {data ? data.location.name : ""}</h1>
                            <RefreshCcw className="text-gray-600 hover:text-gray-400" />
                        </div>
                        <h3 className="font-semibold text-s text-gray-400">
                            {(() => {
                    ...
                    <div className="mt-8 flex flex-row gap-20 h-[23%] bg-gray-700/30 rounded-xl p-4">
                        <img
                        ...
                        <div className="flex flex-col">
                            <h1 className="font-bold text-6xl text-gray-300">{data?.current?.temp_c}<sup>o</sup>C</h1>
